...
export function Hero() {
  return (
    <Section
      className="relative isolate flex min-h-[calc(100vh-65px)] items-center overflow-hidden bg-foreground text-white"
      spacing="none"
    >
      <Image
      ...
      <Container className="py-20 sm:py-28 lg:py-32">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl leading-none font-bold text-balance sm:text-6xl lg:text-7xl">
            Agent Team for Founders
          </h1>
          <p className="mt-6 max-w-2xl text-xl leading-9 text-[#d9e7e2] sm:text-2xl">
